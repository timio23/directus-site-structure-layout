 ...
 */
export function getItemRoute(collection: string | null, primaryKey: string | number, versionKey: string | null = null) {
	if (collection === null) return '';
	...
	if(versionKey)
		return `${collectionRoute}/${itemRoute}?version=${versionKey}`;
